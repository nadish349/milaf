...
export const Page3Section = () => {
  return (
    ...
    />
      ...
      <div className="absolute z-20 left-[50%] transform -translate-x-1/2 top-[60px] sm:top-[70px] md:top-[80px] lg:top-[90px] xl:top-[100px] max-sm:top-[20px] max-sm:px-4">
        <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-normal text-white leading-tight tracking-wide text-center max-sm:text-lg">
      ...
      {/* Description text */}
      <div className="absolute z-20 left-[20%] top-[160px] sm:top-[170px] md:top-[180px] lg:top-[190px] xl:top-[200px] max-sm:left-1/2 max-sm:transform max-sm:-translate-x-1/2 max-sm:top-[60px] max-sm:px-4">
      ...
      <div className="absolute z-20 left-1/2 transform -translate-x-1/2 top-[240px] sm:top-[260px] md:top-[280px] lg:top-[300px] xl:top-[320px] max-sm:top-[140px] max-sm:px-4">
        <div className="flex flex-col sm:flex-row items-start justify-center space-y-6 sm:space-y-0 sm:space-x-2 lg:space-x-3 xl:space-x-4">
          ...
          <div className="flex flex-col items-center min-w-[240px] sm:min-w-[280px] md:min-w-[320px] lg:min-w-[360px] xl:min-w-[400px] h-[200px] sm:h-[220px] md:h-[240px] lg:h-[260px] xl:h-[280px] max-sm:min-w-[280px] max-sm:h-[180px] justify-between">
            <div className="w-full">
              ...
              <p className="text-xs sm:text-xs md:text-xs lg:text-sm xl:text-base text-white leading-relaxed text-left max-w-[220px] sm:max-w-[260px] md:max-w-[300px] lg:max-w-[340px] xl:max-w-[380px] max-sm:text-xs max-sm:max-w-[260px] max-sm:mx-auto px-8 max-sm:px-4">
