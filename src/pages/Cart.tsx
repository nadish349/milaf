...
export const Cart = (): JSX.Element => {
  ...
  console.log('👤 Cart component - isGuest:', isGuest);
                        ...
                        >
                          ...
                          >
                            <img
                              ...
                              onLoad={() => console.log('🖼️ Cart image loaded for:', item.name)}
                        ...
                        >
                          ...
                          <div className="w-12 h-12 rounded-lg overflow-hidden flex-shrink-0 mr-3">
                            <img
                              ...
                              alt={item.name}
                              className="w-full h-full object-contain p-1"
                              onLoad={() => console.log('🖼️ Cart summary image loaded for:', item.name)}
                              onError={() => console.log('❌ Cart summary image failed to load for:', item.name)}
                            />
                          </div>
